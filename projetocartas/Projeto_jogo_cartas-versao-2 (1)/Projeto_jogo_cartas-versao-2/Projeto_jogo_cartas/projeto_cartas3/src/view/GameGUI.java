...
public class GameGUI implements ActionListener {
    ...
    public static void main(String[] args) {
        //new GameGUI();
        // ou algo similar dependendo da sua implementação
    ...
    public GameGUI(Jogador jogador1, Jogador jogador2) {
    ...
    public void atualizarPainelCriaturas(Jogador jogador, JPanel painelCriaturas) {
        ...
        for (Carta carta : jogador.getMao()) {
            ...
            cartaBotao.addActionListener(e -> {
                ...
                Carta cartaSelecionada = carta; // Atualiza a carta selecionada
            });
